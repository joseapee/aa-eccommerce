                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="card-box">
                                            ...
                                            <form action="" method="POST" id="assignClassTeacherForm" class="form-horizontal" role="form">
                                                ...
                                                <div class="form-group mb-0 justify-content-end row">
                                                    <div class="col-sm-12">
                                                        <button name="assign-class-teacher" value="1" type="submit" class="btn btn-info waves-effect waves-light">Save</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>  <!-- card-box  -->
